...
class GlobalSearch {
  ...
  loadProducts() {
    ...
    this.products = [
      ...
      {
        id: 63,
        name: "Appareil Électronique Premium",
        category: "High-Tech",
        price: "261,000 XAF",
        originalPrice: "327,000 XAF",
        page: "index.html",
        image: "Projet 1 - MarketPlace/produits/elec249_1.jpg",
        keywords: ["électronique", "gadget", "high-tech", "premium"]
      },
      {
        id: 64,
        ...
        category: "Accessoires",
        price: "19,600 XAF",
        originalPrice: "32,700 XAF",
        page: "index.html",
        image: "Projet 1 - MarketPlace/produits/adapteurdongleiphone_1.jpg",
        keywords: ["adaptateur", "iphone", "dongle", "accessoires"]
      },
      {
        id: 65,
        ...
        category: "Cuisine",
        price: "58,900 XAF",
        originalPrice: "78,600 XAF",
        page: "index.html",
        image: "Projet 1 - MarketPlace/produits/elec249_1.jpg",
        keywords: ["mixeur", "portable", "batterie", "cuisine"]
      },
      {
        id: 66,
        name: "Bose 500 Sound Bar",
        category: "Audio, Hifi",
        price: "392,000 XAF",
        originalPrice: "523,000 XAF",
        page: "audio-hifi.html",
        image: "Projet 1 - MarketPlace/produits/bose500_.jpg",
        keywords: ["bose", "barre de son", "audio", "hifi"]
      },
      {
        id: 67,
        name: "Barre de Son Premium",
        category: "Audio, Hifi",
        price: "228,000 XAF",
        originalPrice: "327,000 XAF",
        page: "audio-hifi.html",
        image: "Projet 1 - MarketPlace/produits/barredeson_1.jpg",
        keywords: ["barre de son", "audio", "home cinéma"]
      },
      {
        id: 68,
        name: "Chaîne Hifi Premium",
        category: "Audio, Hifi",
        price: "1,310,000 XAF",
        originalPrice: "1,580,000 XAF",
        page: "audio-hifi.html",
        image: "Projet 1 - MarketPlace/produits/chainhifi_1.jpg",
        keywords: ["chaîne hifi", "audio", "musique"]
      },
      {
        id: 69,
        ...
        keywords: ["jbl", "flip", "enceinte", "bluetooth"]
      }
    ];
  }
